...
class RegisterUserDTOResolver implements ArgumentValueResolverInterface
{
    ...
    {
        return $argument->getType() === RegisterUserDTO::class;
    }
    ...
    public function resolve(Request $request, ArgumentMetadata $argument): iterable
    {
        ...
        $dto         = RegisterUserDTO::createFromRequestData($requestData);

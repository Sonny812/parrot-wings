...
class MakeTransactionDTOResolver implements ArgumentValueResolverInterface
{
    ...
    {
        return $argument->getType() === MakeTransactionDTO::class;
    }
    ...
    public function resolve(Request $request, ArgumentMetadata $argument): iterable
    {
        ...
        $dto         = MakeTransactionDTO::createFromRequestData($requestData);
